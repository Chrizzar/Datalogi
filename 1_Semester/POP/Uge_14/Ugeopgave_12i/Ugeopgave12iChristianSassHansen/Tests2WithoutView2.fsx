...
(*
// hourHand
let mutable hourHand =  [|Point (200,200); Point (200,115)|] //[|Point (0,0);Point (0,-45)|]
// MinuteHand
let mutable minuteHand = [|Point (200,200); Point (200,50)|] // [|Point (0,0);Point (0,-20)|]
// SecondHand
let mutable secondHand = [|Point (200,200); Point (200,20)|] // [|Point (0,0);Point (0,-20)|]
*)

(*
// hourHand                                   [This Point]
let mutable hourHand =  [|Point (0,0);Point (0,-45)|]//[|Point (200,200); Point (200,115)|] //[|Point (0,0);Point (0,-45)|]
// MinuteHand
let mutable minuteHand = [|Point (0,0);Point (0,-20)|]// [|Point (200,200); Point (200,145)|] // [|Point (0,0);Point (0,-20)|]
// SecondHand
let mutable secondHand = [|Point (0,0);Point (0,-20)|] //[|Point (200,200); Point (200,110)|] // [|Point (0,0);Point (0,-20)|]
*)
