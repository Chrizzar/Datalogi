...
/// Model of a triangle and simple transformation of it.
/// See also file 23.8_transformWindows2.fsx 
/// and file 23.9__transformWindows3.fsx and figure 23.9.
...
let model () : Size * ((Pen * (Point [])) list) =
    ...
    let shapes =
        [(black, lines);
        (red, translate (Point (100, 30)) lines);
