...
printfn "Testing for 2 elements: %A -> %A = %A" ([25;50]) (msort [25;50]) ([25;50] = msort [25;50])

// Testing for 2 elements vise versa sorted
printfn "Testing for 2 elements: %A -> %A = %A" ([25;50]) (msort [25;50]) ([25;50] = msort [25;50])

// Testing for 3 elements
printfn "Testing for 3 elements: %A -> %A = %A" ([10;46;83]) (msort [10;46;83]) ([10;46;83] = msort [10;46;83])
...
(*
let testcases = [[];[1];[1;2];[2;1];[1;2;3];[3;2;1];[2;3;1]]

let tests testcases =
    for xs in testcases do
        for ys in testcases do
            printfn "%A" (merge xs ys)
*)
